...
-- type ProgressCounter = MVar Integer -- A counter for the number completed, but not yet included in progress bar
...
-- incrementCounter pc = modifyMVar_ pc (return . (+1))
